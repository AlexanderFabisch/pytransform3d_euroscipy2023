...
\begin{tabular}{lllll}
\toprule
& Term & & Displacement & Representation\\
\midrule
\includegraphics[width=1cm]{images/intro_position} &
position &
\includegraphics[width=1cm]{images/intro_translation}
& translation & $\mathbb{R}^3$\\
\midrule
\includegraphics[width=1cm]{images/intro_frame} &
orientation &
\includegraphics[width=1cm]{images/intro_rotation}
& rotation & $SO(3)$\\
\midrule
& pose & & rigid transformation & $SE(3)$\\
\bottomrule
\end{tabular}
\end{frame}
